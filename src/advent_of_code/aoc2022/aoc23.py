...
def test_read(sample_input):
    expected = [
        # fmt: off
        (4, 0), (2, 1), (3, 1), (4, 1), (6, 1), (0, 2), (4, 2), (6, 2), (1, 3), (5, 3), (6, 3),
        (0, 4), (2, 4), (3, 4), (4, 4), (0, 5), (1, 5), (3, 5), (5, 5), (6, 5), (1, 6), (4, 6),
        # fmt: on
    ]
...
def test_propose_moves(sample_input):
    expected = [
        # fmt: off
        (4, -1), (2, 0), (3, 1), (5, 1), (6, 0), (0, 1), (4, 2), (7, 2), (1, 3), (5, 3), (6, 4),
        (-1, 4), (2, 4), (3, 3), (4, 4), (-1, 5), (1, 5), (3, 5), (5, 5), (6, 4), (1, 7), (4, 7),
        # fmt: on
    ]
...
def test_make_moves(sample_input):
    expected = [
        # fmt: off
        (4, -1), (2, 0), (3, 1), (5, 1), (6, 0), (0, 1), (4, 2), (7, 2), (1, 3), (5, 3), (6, 3),
        (-1, 4), (2, 4), (3, 3), (4, 4), (-1, 5), (1, 5), (3, 5), (5, 5), (6, 5), (1, 7), (4, 7),
        # fmt: on
    ]
    elves = read(sample_input)
